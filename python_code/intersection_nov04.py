...
availability_dictionary = [
    ...
    {"person": 3, "slot": 2, "location": 2},
    {"person": 3, "slot": 3, "location": 2},
    {"person": 4, "slot": 1, "location": 1},
    {"person": 4, "slot": 2, "location": 1},
    {"person": 5, "slot": 2, "location": 3},
...
def execute_meeting_organizer():
    ...
    #doc3 = {0, 1, 3}
    #doc4 = {0, 1, 4}
    doc_without_agenda = [doc1, doc2, doc3, doc4, doc5, doc6, doc7]
