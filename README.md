...
3. **Participant Determination**
   ...
   2. **Confidentiality Filtering** – Applies:
      - **Union logic** for *public documents*  
      - **Intersection logic** for *private documents*  
...
5. **Privacy-Aware Slot Ranking**
   ...
   \[
   \text{Average Security Score} = \frac{1}{n} \sum_{i=1}^{n} s_i
   \]

   where \( s_i \) is the security score of the *i-th* participant’s location:
   - Work (Most Secure): `1`  
   - Home: `2`  
